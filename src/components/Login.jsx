...
const Login = () => {
  const { showLoginForm, setShowLoginForm } = useStoreContext();
  ...
  return (
    showLoginForm && (
      <div
        ...
        className="fixed inset-0 flex items-center bg-black/50 z-100"
      >
        <form
          ...
          {state === "register" ? (
            <p>
              ...
              <span
                ...
                className="text-[var(--color-primary-dull)] cursor-pointer"
              >
                click here
              </span>
            </p>
